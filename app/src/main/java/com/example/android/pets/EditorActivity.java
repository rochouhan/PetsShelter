...
// the view, and we change the mPetHasChanged boolean to true.
    ...
    private View.OnTouchListener mTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View view, MotionEvent motionEvent) {
            mPetHasChanged = true;
            Toast.makeText(EditorActivity.this, ""+mPetHasChanged, Toast.LENGTH_SHORT).show();
            return false;
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.v(LOG_TAG, "gender = " + mGender);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_editor);

        //get intent passed from Catalog activity
    ...
    private void savePets(){
        ...
        if (petUri == null ) {
            Uri id = getContentResolver().insert(PetContract.CONTENT_URI, petValues);
            if (id == null) {
            ...
            int id = getContentResolver().update(petUri, petValues, null, null);
            if (id == 0) {
                // If the new content URI is null, then there was an error with insertion.
                Toast.makeText(this, getString(R.string.editor_insert_pet_failed),
                        Toast.LENGTH_SHORT).show();
    ...
    public int checkValidInput(){
        ...
        //if the user did not insert any information into the fields but accidentally clicked save
        if(TextUtils.isEmpty(name) && TextUtils.isEmpty(breed) && TextUtils.isEmpty(weightString) && gender == PetEntry.GENDER_UNKNOWN){
            result = 0;
        }
        //if the user did not enter all of the necessary information before clicking save
        else if (TextUtils.isEmpty(name) || TextUtils.isEmpty(breed)){
            result = 1;
        }
        else{
            result = 2;
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        return new android.content.CursorLoader(this, petUri, projection, null,
                null, null);
    }
    ...
    private void deletePet() {
        int result = -1;
        if (petUri != null){
            result = getContentResolver().delete(petUri, null, null);
        }
        if (result == 1){
            Toast.makeText(this, "pet deleted", Toast.LENGTH_SHORT);
        }
        else{
            Toast.makeText(this, "pet successfully deleted", Toast.LENGTH_SHORT);
        }
        finish();
